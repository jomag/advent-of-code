...
def part2(data: List[str], verbose=False):
    ...
    while q:
        ...
        if ((dir == "n" and steps < 9) or (dir in "ew" and steps > 2)) and y > 0:
        ...
        if ((dir == "s" and steps < 9) or (dir in "ew" and steps > 2)) and y < h - 1:
        ...
        if ((dir == "w" and steps < 9) or (dir in "sn" and steps > 2)) and x > 0:
        ...
        if ((dir == "e" and steps < 9) or (dir in "sn" and steps > 2)) and x < w - 1:
    ...
    targets = [
        node
        for node in m
        if node[0] == target[0] and node[1] == target[1] and node[3] > 2
    ]
